...
| --- | --- |
| `interactiveLogin` and `interactiveLoginWithAuthResponse` which return `DeviceTokenCredentials` | [`DeviceCodeCredential`](https://github.com/Azure/azure-sdk-for-js/blob/main/sdk/identity/identity/samples/AzureIdentityExamples.md#authenticating-a-user-account-with-device-code-flow) |
| `loginWithUsernamePassword` and `loginWithUsernamePasswordWithAuthResponse` which return `UserTokenCredentials` | [`UsernamePasswordCredential`](https://github.com/Azure/azure-sdk-for-js/blob/main/sdk/identity/identity/samples/AzureIdentityExamples.md#authenticating-a-user-account-with-username-and-password) |
| `loginWithServicePrincipalSecret` and `loginWithServicePrincipalSecretWithAuthResponse` which return `ApplicationTokenCredentials` | [`ClientSecretCredential`](https://github.com/Azure/azure-sdk-for-js/blob/main/sdk/identity/identity/samples/AzureIdentityExamples.md#authenticating-a-service-principal-with-a-client-secret) |
| `loginWithAuthFile` and `loginWithAuthFileWithAuthResponse` | `@azure/identity` does not currently support reading authentication details from a file. Use other credentials, such as [`ClientSecretCredential`](https://github.com/Azure/azure-sdk-for-js/blob/main/sdk/identity/identity/samples/AzureIdentityExamples.md#authenticating-a-service-principal-with-a-client-secret) or [`ClientCertificateCredential`](https://github.com/Azure/azure-sdk-for-js/blob/main/sdk/identity/identity/samples/AzureIdentityExamples.md#authenticating-a-service-principal-with-a-client-certificate) |
| `loginWithVmMSI`, which returns `MSIVmTokenCredentials` | [`ManagedIdentityCredential`](https://github.com/Azure/azure-sdk-for-js/blob/main/sdk/identity/identity/samples/AzureIdentityExamples.md#authenticating-azure-hosted-applications) |
| `loginWithAppServiceMSI`, which returns `MSIAppServiceTokenCredentials` | [`ManagedIdentityCredential`](https://github.com/Azure/azure-sdk-for-js/blob/main/sdk/identity/identity/samples/AzureIdentityExamples.md#authenticating-azure-hosted-applications) |
| `loginWithServicePrincipalCertificate` and `loginWithServicePrincipalCertificateWithAuthResponse`, which return `ApplicationTokenCertificateCredentials` | [`ClientCertificateCredential`](https://github.com/Azure/azure-sdk-for-js/blob/main/sdk/identity/identity/samples/AzureIdentityExamples.md#authenticating-a-service-principal-with-a-client-certificate) |
