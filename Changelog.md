...
- Added support for passing a `clientId` property in the `MSIAppServiceOptions` parameter of the `MSIAppServiceTokenCredentials`, allowing user-assigned managed identities to be used to authenticate through Azure App Services.
